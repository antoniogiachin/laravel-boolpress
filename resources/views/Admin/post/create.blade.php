...
@section('content')
    <div class="container px-5">
        <h1 class="my-3">Inserisci un nuovo post</h1>
        ...
        <form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="form-floating">
                    <textarea class="form-control" style="min-height: 250px" placeholder="Inserisci il post qui" id="content" name="content" rows="50">{{ old('content') }}</textarea>
